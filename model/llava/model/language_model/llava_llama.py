...
class LlavaConfig(LlamaConfig):
    ...
    def __init__(self, **kwargs):
        ...
        # Add missing attributes for compatibility with newer transformers
...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        clip_resize_list: Optional[List[int]] = None,
        ...
        return CausalLMOutputWithPastAndFeature(
            ...
            hidden_states=outputs.hidden_states if self.training else hidden_states,
