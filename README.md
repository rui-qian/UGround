...
| [UGround-LLaVA-v1.5-7B(fp-refcoco)](https://huggingface.co/rui-qian/hf-UGround-7b_fp_refer_seg_llava1.5_ema/tree/main)  |See:85.86 cIoU:62.80|  [archive](https://huggingface.co/rui-qian/hf-UGround-7b_fp_refer_seg_llava1.5_ema/blob/main/UGround7B-fprefcoco.png) | [weights](https://huggingface.co/rui-qian/hf-UGround-7b_fp_refer_seg_llava1.5_ema/tree/main) [\[logs\]](https://huggingface.co/rui-qian/hf-UGround-7b_fp_refer_seg_llava1.5_ema/raw/main/meta_1.log)
| [UGround-LLaVA-v1.5-7B(fp-refcoco+)](https://huggingface.co/rui-qian/hf-UGround-7b_fp_refer_seg_llava1.5_ema/tree/main)  |See:85.10 cIoU:56.03|  [archive](https://huggingface.co/rui-qian/hf-UGround-7b_fp_refer_seg_llava1.5_ema/blob/main/UGround7B-fprefcoco%2B.png) | [weights](https://huggingface.co/rui-qian/hf-UGround-7b_fp_refer_seg_llava1.5_ema/tree/main) [\[logs\]](https://huggingface.co/rui-qian/hf-UGround-7b_fp_refer_seg_llava1.5_ema/raw/main/meta_1.log)
...
> [!TIP]
> Please note that CUDA 11.7 (cu117) and CUDA 11.8 (cu118) may lead to slight differences in results. Based on our tests, both cu117 and cu118 can be installed successfully on **NVIDIA A100-SXM4-40GB**; however, **cu117 fails to install on NVIDIA H800**. See also: [*build.sh*](./build.sh). (Credit: Chuanhang Deng)
