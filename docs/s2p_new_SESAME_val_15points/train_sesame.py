...
def parse_args(args):
    ...
    #parser.add_argument("--val_dataset", default="refcoco", type=str)
    ...
    parser.add_argument("--dice_loss_weight", default=4, type=float)
    ...
    if args.no_eval == False:
        ...
        if os.path.exists(pickle_path):
            with open(pickle_path, 'rb') as f:
                ...
                # print(len(conversation_records))
        ...
        if args.val_dataset in reason_seg_dataset:
            ...
            val_dataset = TestReferDataset(
                ...
                args.image_size,
                datasetname=args.val_dataset,
                train_test_split="testB", # val|test|testA|testB
                conversation_records=conversation_records
        )
        print(
