...
# VERSION="../backup/LISA7B/LISA-7B-v1-explanatory" \
...
EXP_NAME="sesame_reasoning_val_15"
#BATCH_SIZE=2     ####????????????????????????????????
BATCH_SIZE=2     ####????????????????????????????????
# BATCH_SIZE=12
...
GPU_SETTINGS="localhost:3"   # Pass GPU settings, e.g., 'localhost:0,1'
MASTER_PORT="15994"    # Pass master port, e.g., '15990'
...
#SAMPLE_RATES_REASONSEG="3,10,2,3,1,10"
#SAMPLE_RATES_REASONSEG="10,10,1,1,1,10"
SAMPLE_RATES_REASONSEG="10,1,1,1,1,10"
# SAMPLE_RATES_REASONSEG="0,0,0,0,0,10"
